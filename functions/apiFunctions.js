...
module.exports = {
  isDay: async () => {
    const {data} = await axios.get('http://api.weatherapi.com/v1/current.json?key=0216e5000c42499d86e23844203112&q=TN11%208DY')
  ...
  setHueLights: async (api, light1, light2,) => {
    ...
    if (!hue1.data[0] || !hue1.data[0].success || !hue1.data[1] || !hue1.data[1].success) {
      return false
    }
    return true
  }
